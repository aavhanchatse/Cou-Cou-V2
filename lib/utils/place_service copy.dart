  ...
  Future<Place?> getPlaceDetailFromId(String placeId) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (result['status'] == 'OK') {
        ...
        // location
        var coordinateLoc = result['result']['geometry'];
        if (coordinateLoc.toString().contains('location')) {
          place.location = LocationClass();
          place.location!.lat = coordinateLoc['location']['lat'];
          place.location!.lng = coordinateLoc['location']['lng'];
        }
